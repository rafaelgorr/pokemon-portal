...
} from '../../interfaces/domain/Ability'

export const mapPokemonAbilityToDomain = (
...
export const mapAbilityPokemonToDomain = (
...
export const mapAbilityToDomain = (ability: Ability): DomainAbility => ({
  ...
  effect:
    ability.effect_entries.find((eE) => eE.language.name === 'en')?.effect ??
    '',

...
export const actions = {
  getMoves: createAsyncThunk(`${prefix}/getMoves`, async (input: api.GetPokemonMoves['input'], thunkApi) => {
    try {
  ...
  getMoveById: createAsyncThunk(
    `${prefix}/getMoveById`,
    async (input: WithSuccess<api.GetPokemonMove['input'], api.GetPokemonMove['output']>, thunkApi) => {
      try {
